...
const TreeView = ({ stories, story, updateStory, allExpanded, searchRef, setTreeRootRef, hotkeys, }) => {
    const treeItemRefs = React.useRef({});
    const [tree, setTree] = React.useState(getStoryTree(stories, story, allExpanded));
    React.useEffect(() => {
